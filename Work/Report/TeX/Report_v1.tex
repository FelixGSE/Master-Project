...
Let $Q_t(a)$ be the value function of action $a$. \textit{"Epsilon Greedy"}

Choose next action $a$ as $a_{t+1} = \arg \max Q_t(a)$. Let $p_e$ be the probability of exploration. $p=\epsilon$
