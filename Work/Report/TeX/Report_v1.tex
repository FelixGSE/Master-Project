...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{ l|ccccc} 
		\toprule 
		\textbf{Criminal profile} & \textbf{Count} & \textbf{Age} & \textbf{TABE Score} & \textbf{Education} & \textbf{Beta IQ} \\ 
		\hline
...
\begin{table}[!htbp] \centering 
	...
	\label{} 
	\scriptsize 
	\resizebox{\textwidth}{!}{\begin{tabular}{@{\extracolsep{0pt}} llcccccccccc} 
\toprule 
