...
os.chdir('/Users/felix/Documents/GSE/Term 3/External Data/stout/s_Stout_etal_2004_cocaine')  
...
# Run computation 06
os.chdir('/Users/felix/Documents/GSE/Term 3/Master_Project/Master-Project/Work/Code and Analysis/Results/Real data')
...
avg_frame.to_csv("cocaine_average.csv")
test2 = pd.concat([frame_list[0].ix[:,:9],aux.statistics_df(frame_list,cols)],axis=1)))

import pickle

pickle.dump(frame_list, 'cocaine_frame_list')

with open('cd.pickle', 'wb') as handle:
  pickle.dump(frame_list, handle)
